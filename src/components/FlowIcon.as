package components
{
	...
	public class FlowIcon extends Image
	{
		...
		private function events(): void{
			...
			this.addEventListener(MouseEvent.DOUBLE_CLICK, onIconDoubleClick);
		}
		...
		//触发鼠标移动事件
		private function onIconDoubleClick(event: MouseEvent): void{
			var e: IconEvent= new IconEvent(IconEvent.ICON_DOUBLE_CLICK);
			e.icon = this;
			this.dispatchEvent(e);	
		}
	}
